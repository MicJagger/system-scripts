...
# edit: this is written by aaronfranke @ https://github.com/aaronfranke/Linux-tools/blob/master/ubuntu-only/setup.sh
# i am not him and this is fantastic so i decided to steal it
# i made a few edits but theyre mostly / all labelled
...
echo
sudo sleep 5 # sudo before sleep elevates this script to sudo priviliges after the password prompt.
